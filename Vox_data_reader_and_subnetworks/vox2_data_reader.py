...
class DataReader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            video_path = "%s%s/%s/%s.mp4" % (self.video_prefix, speaker_id, video_id.split('/')[-1], audio_path_wav.split('/')[-1].split('.')[0])
            ...
            #----------------------------------------------------------------
            if self.engine == "librosa":
                Zxx = librosa.core.stft(raw_data.astype(float), hop_length=ModelConfig.L_HOP, n_fft=ModelConfig.L_FFT)
                Zxx1 = Zxx**0.3
                D = np.abs(Zxx1)
...
if __name__ == "__main__":
    CSV_META = "/Users/Nostalgia/Documents/2019_Winter/414/project/vox2/vox2_meta_small.csv" # "test with modified small scale meta csv"
    VIDEO_PREFIX = "/Users/Nostalgia/Documents/2019_Winter/414/project/vox2/vox2_dev_mp4/dev/mp4/" # "change to your own local path"
    AUDIO_PREFIX = "/Users/Nostalgia/Documents/2019_Winter/414/project/vox2/vox2_aac/dev/aac/" # "change to your own local path"
    ...
    print("==================================")
    print("Test single output:")
    test_single_input = db[0]


    original = test_single_input["raw_data"]
    D = librosa.core.stft(original.astype(float), hop_length=ModelConfig.L_HOP, n_fft=ModelConfig.L_FFT)
